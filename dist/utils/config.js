...
var config = {
  ...
  emailTags: {
    company_name: 'Delma Nicolace',
    company_address: 'Lisboa, Portugal',
    company_email: 'info@delmanicolace.com',
    company_url: 'delmanicolace.com',
    app_name: 'Delma Nicolace',
    app_color: '#B823BA',
    logo: 'https://delma-assets.s3.eu-west-1.amazonaws.com/logo.png',
    logo_small: 'https://delma-assets.s3.eu-west-1.amazonaws.com/logo.png'
  },
  storeLinks: {
