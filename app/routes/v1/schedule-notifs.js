...
const getScheduleNotification = async (req) => {
    ...
    if (id) {
        scheduleNotification = await ScheduleNotification.findOne({ _id: id }).lean();
...
const postScheduleNotification = async (req) => {
    ...
    const scheduleNotification = await ScheduleNotification.findOne({ _id: newScheduleNotification._id }).lean();
...
const putScheduleNotification = async (req) => {
    ...
    const scheduleNotification = await ScheduleNotification.findOneAndUpdate({ _id: id }, body, { new: true }).lean();
